  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-black">로컬 워커 (클로드 구독 연결)</h1>
      </div>
      ...
      <div className="border border-border p-6 mb-6">
        ...
        <div className="flex gap-3">
          ...
          >
            <div className="font-black text-sm mb-1">로컬 워커 (클로드 구독)</div>
            <div className="text-[11px] text-neutral-400">{anyOnline ? '추가 과금 없음' : '워커 연결 후 선택 가능'}</div>
          </button>
        </div>
      </div>
